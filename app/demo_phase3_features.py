    ...
    async def demonstrate_multitime_analysis(self, symbol="BTCUSDT"):
        ...
        for tf in timeframes:
            try:
                ...
                data = await self.data_provider.get_historical_data(symbol, tf, limit=100)
                ...
                if data and len(data) > 20:
                    ...
                    neural_prediction = await self.neural_processor.analyze_timeframe(data, tf)
                    ...
                    print(f"  {tf.upper():>4} | Trend: {trend:>10} | Confidence: {confidence:.1%} | Signal: {signal_strength:.2f}")
    ...
    async def demonstrate_neural_consensus(self, symbols=["BTCUSDT", "ETHUSDT"]):
        ...
        for symbol in symbols:
            try:
                ...
                consensus_data = await self.neural_processor.get_consensus_analysis(symbol)
                ...
                if consensus_data:
                    ...
                    signal_emoji = "🟢" if overall_signal == "BUY" else "🔴" if overall_signal == "SELL" else "🟡"
                    ...
                    if 'timeframe_signals' in consensus_data:
                        ...
                        for tf, signal in consensus_data['timeframe_signals'].items():
                            tf_emoji = "🟢" if signal == "BUY" else "🔴" if signal == "SELL" else "🟡"
